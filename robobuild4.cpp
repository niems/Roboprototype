...
//enum {STATIC_TYPE, DYNAMIC_TYPE, KINEMATIC_TYPE}; //used with the editor to determine
...
void drawText(sf::RenderWindow &window, sf::Text &text) //draws the game mode text to the screen
{
	window.draw(text);
}
